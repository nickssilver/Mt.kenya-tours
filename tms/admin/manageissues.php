...
<div class="agile-grids">
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Issues</h2>
						<button  style="float:right;" class="btn btn-success btn-mini"><a href="javascript:void(0);" onclick="printPageArea('table')">Print</button></a>
